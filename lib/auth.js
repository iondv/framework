...
var ExtAuth = module.exports.bindExternalAuth = function (a, nm, path, success, fail) {
  a.get(path + '/auth/' + nm, passport.authenticate(nm, pc.options.claim));
...
/**
 * @param {{}} app
 * @param {{ DataSource: DataSource, localAuthDs: String, authCallbacks: String[], passports: Object[] }} conf
 */
module.exports.init = function (app, conf) {
  ...
  if (!config.denyTopLevel) {
    ...
    router.post('/auth', SignInHandler('/auth'));
  }
