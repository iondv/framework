...
function CustomProfile(options = {}) {
  ...
  function recursion(master, cn, opts, eager, needed, props) {
    let f = [];
    ...
    return options.dataRepo.getList(
      ...
      list.forEach((item) => {
        ...
        r = r.then(() => recursion(item, cn, eager, needed, props));
      });
      return r;
    });
  }
            ...
            result = result
              ...
              .then((list) => {
                ...
                list.forEach((item) => {
                  ...
                  if (opts.recursion) {
                    r = r.then(() => recursion(item, className, opts, eager, needed, props));
                  }
                });
                return r;
              });
