...
функциональность, визуальной среды визуальной среды [Studio](https://studio.iondv.com) для разработки метаданных приложений [с открытым кодом](https://github.com/iondv/studio). Смоделированное в виде UML-схемы веб-приложение можно запустить за [80 секунд](https://youtu.be/s7q9_YXkeEo).
