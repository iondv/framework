...
функциональность, визуальной среды, а также
визуальной среды [Studio](https://studio.iondv.com) для разработки метаданных приложений [с открытым кодом](https://github.com/iondv/studio) . 
Нарисованное веб-приложение можно запустить за [80 секнуд](https://youtu.be/s7q9_YXkeEo).
