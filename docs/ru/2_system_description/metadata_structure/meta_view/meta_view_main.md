...
| `"type"`                | [**Тип**](/docs/ru/2_system_description/metadata_structure/meta_view/view_types.md)                        | Целое - идентификатор (код) типа             | Тип представленияя атрибута.                                                                                                                        |
...
| `"mask"`                | [**Маска**](/docs/ru/2_system_description/metadata_structure/meta_view/mask.md)                      | Строка                                       | Позволяет ограничить допустимые значения атрибута.                                                                                                         |
