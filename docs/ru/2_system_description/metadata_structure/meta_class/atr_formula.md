...
Например, есть исходные значения в коллекции "ownOrg1", "ownOrg1", "ownOrg2". Если надо получить "ownOrg1, ownOrg2", то для этого пригодится выше описанная формула для вычисляемого атрибута с использованием функции `merge`.
...
В объекте обязательно нужно указать [подходящую функцию](/docs/ru/2_system_description/metadata_structure/meta_class/atr_formula.md#%D0%BF%D0%BE%D0%B4%D0%B4%D0%B5%D1%80%D0%B6%D0%B8%D0%B2%D0%B0%D0%B5%D0%BC%D1%8B%D0%B5-%D1%84%D1%83%D0%BD%D0%BA%D1%86%D0%B8%D0%B8) в `function1` с необходимым количеством операндов для получения результата.
