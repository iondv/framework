...
| `"indexed"`            | [**Индексировать для поиска**](/docs/ru/2_system_description/metadata_structure/meta_class/atr_indexed.md)               | Логический                           | Указывает, нужно ли индексировать значения данного атрибута для ускорения поиска.                                                                                                                                                                                     |
