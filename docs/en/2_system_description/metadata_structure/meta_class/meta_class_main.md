...
| `"semantic"`         | [**Semantic attribute**](/docs/en/2_system_descriptionmetadata_structure/meta_class/semantic.md)       | String.                                | Sets the semantics - the rule of forming the row view for this class.                                                                                      |
...
| `"changeTracker"`    | [**Time tag of commited changes**](/docs/en/2_system_description/metadata_structure/meta_class/time_user_tracker.md)     | String.                                 | Allows to save data/time of the object change, requires the presence of the corresponding class attribute, the `name` of which is entered into this field.               |
