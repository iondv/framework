...
### The previous page: [Meta section navigation](navigation_section.md)
...
| `"title"`       | [**Title**](title.md)         | String                               | Allows to optionally specify the title of the page.                                                                                                                                                                                                         |
...
| `"conditions"`  | [**Sample conditions**](conditions.md)   | Array of objects                      | Filter when opening a list of objects. Used for “Page Class” and “Container Page” nodes.                                                                                                                                                                                                              |
...
--------------------------------------------------------------------------  
 ...
 #### [Licence](/LICENSE) &ensp;  [Contact us](https://iondv.com/portal/contacts) &ensp;  [Russian](/docs/ru/2_system_description/metadata_structure/meta_navigation/navigation_nodes.md)   &ensp;
