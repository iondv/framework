...
| `"conditions"`  | [**Sample conditions**](/docs/en/2_system_description/metadata_structure/meta_navigation/conditions.md)   | Array of objects                      | Filter when opening a list of objects.                                                                                                                                                                                                               |
